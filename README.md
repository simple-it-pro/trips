# 🗺️ Travel Recommendations - Умный поиск мест
...
Сейчас приложение работает с тестовыми данными. Для подключения к реальному бэкенду:

1. Настройте бэкенд API (отдельный репозиторий)
2. Обновите файл `src/App.tsx`, заменив заглушку на реальный API запрос
3. Добавьте файл `.env` с URL вашего бэкенда
